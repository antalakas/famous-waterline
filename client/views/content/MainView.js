define('MainView', [], function(require, exports, module) {
    ...
    var SwapperControllerView   = require('SwapperControllerView');
    var TicketPanelView         = require('TicketPanelView');
    var AdminPanelView          = require('AdminPanelView');
    var ReportPanelView         = require('ReportPanelView');
    var SettingPanelView        = require('SettingPanelView');
    var MapPanelView            = require('MapPanelView');
