define('MultiView', [], function(require, exports, module) {
    ...
    var LightboxControllerView = require('LightboxControllerView');
    ...
    function _createASurface(pageCount) {
        ...
        UI.insert(UI.render(Template.SearchItinerary1), div);
